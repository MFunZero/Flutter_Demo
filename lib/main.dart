...
import 'package:edu_flutter/Dio.dart';
import 'package:edu_flutter/File.dart';
import 'package:edu_flutter/Websocket.dart';
import 'package:edu_flutter/tool/localizations.dart';
...
import 'methodChannel/channel.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: MyHomePage(),//WebSocketRoute(),//FutureBuilderRoute(),//HttpTestRoute(),//FileOperationRoute(),//MyHomePage(),
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: MyHomeChannelPage(),//GradientCircularProgressRoute(),//CustomPaintRoute(),//TurnBoxRoute(), //AnimatedWidgetFadeTest(),
